...
def setup_memory_management():
    ...
    start_memory_monitoring(
        threshold_percent=memory_threshold, check_interval=check_interval
    )

    print(
        f"Memory management initialized - Threshold: {memory_threshold}%, Check interval: {check_interval}s"
    )
