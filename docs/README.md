...
- [Usage Guide](usage.md)
  ...
  #ST|  - [Backup & Restore](usage.md#backup--restore)
#QV|- [Connectivity](connectivity.md)
#YV|  - [External API Endpoints](connectivity.md#external-api-endpoints)
#XK|  - [MCP Servers](connectivity.md#mcp-servers)
#QM|  - [A2A Protocol](connectivity.md#a2a-agent-to-agent-protocol)
#XJ|- [Architecture Overview](architecture.md)
- [Architecture Overview](architecture.md)
  ...
  - [Implementation Details](architecture.md#implementation-details)
   - [Core Components](architecture.md#core-components)
     ...
     - [Coordinator System](architecture.md#coordinator-system)
